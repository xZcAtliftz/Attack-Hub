...
if CoreGui:FindFirstChild("Library") then
    CoreGui:FindFirstChild("Library"):Destroy()
end
...
function Library:Window(name, icon)
    local icon = tostring(icon):match("%d+") or ""
    local name = name or "NoName"
    ...
    Main.Size = UDim2.new(0, 533, 0, 380)
    Main.ZIndex = 2
    ...
    Topbar.Size = UDim2.new(0, 533,0, 50)
    Topbar.ZIndex = 2
    ...
    LOGO.Position = UDim2.new(0.0187617261, 0, 0, 0)
    ...
    Name.Position = UDim2.new(0.112570353, 0, 0, 0)
    ...
    TextLabel.Position = UDim2.new(0.732363939, 0, 0, 0)
    TextLabel.Size = UDim2.new(0, 147, 0, 50)
    TextLabel.ZIndex = 3
    TextLabel.Font = Enum.Font.SourceSans
    TextLabel.Text = "TIME | N/A"
    TextLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
    TextLabel.TextSize = 21.000
    TextLabel.TextXAlignment = Enum.TextXAlignment.Left
    spawn(function()
        while wait() do
            TextLabel.Text = "TIME : "..os.date("%H")..":"..os.date("%M")..":"..os.date("%S")
        end
    end)
    UITabs.Name = "UITabs"
    UITabs.Parent = Main
    ...
    Tabs.Position = UDim2.new(0, 13,0, 75)
    ...
    TabButtons.Size = UDim2.new(0, 514,0, 25)
    TabButtons.ZIndex = 2
    ...
    TweenService:Create(Main, TweenInfo.new(0.5, Library.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 533, 0, 380)}):Play()
    ...
    local function ToggleUI()
        if Library.UIOpen then
            TweenService:Create(Main, TweenInfo.new(0.5, Library.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 0, 0, 0)}):Play()
        ...
        UILibrary.Enabled = Library.UIOpen
    end
    ...
    UserInputService.InputBegan:Connect(function(io, p)
        if io.KeyCode == Library.Theme.UIToggleKey then
            pcall(ToggleUI)
        end
    end)

    local LibraryTabs = {}
    function LibraryTabs:Tab(name)
        ...
        Title.Text = name
        Title.TextColor3 = Library.Theme.TabTextColor
        ...
        function TabElements:Section(name)
            ...
            NameSection.Position = UDim2.new(0, 0, 1.871, 0)
            NameSection.Size = UDim2.new(0, 249, 0, 280)
            ...
            function SectionElements:Label(text)
                ...
                NameLabel.Text = text
                NameLabel.Size = UDim2.new(0, 243, 0, NameLabel.TextBounds.Y)
                NameLabel.ZIndex = 5
                ...
                NameLabel:GetPropertyChangedSignal("TextBounds"):Connect(function()
                    if NameLabel.Text ~= "" then
                        TweenService:Create(NameLabel, TweenInfo.new(0.5, Library.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 247, 0, NameLabel.TextBounds.Y)}):Play()
                    else
                        TweenService:Create(NameLabel, TweenInfo.new(0.5, Library.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 247, 0, 0)}):Play()
                    end
                end)
            ...
            function SectionElements:Toggle(name, default, callback)
                local locktoogle = {}
                ...
                local LockICorner = Instance.new("UICorner")
                local Toggled = false
                ...
                Toggle.BackgroundTransparency = 197
                Toggle.Position = UDim2.new(0, 15, 0, 7)
                Toggle.Size = UDim2.new(0, 210,0, 20)
                Toggle.ZIndex = 5
                ...
                CheckboxOutline.Position = UDim2.new(0.9, -12,0.5, -12)
                ...
                CheckboxTicked.Position = UDim2.new(0.9, -12,0.5, -12)
                ...
                TickCover.Position = UDim2.new(0.9, -7,0.5, -7)
                TickCover.Size = UDim2.new(0, 14, 0, 14)
                TickCover.ZIndex = 5
                
                lock.Name = "lock"
                lock.Parent = Toggle
                lock.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
                lock.BackgroundTransparency = 0.300
                lock.Position = UDim2.new(0.35, -76, 0.528571427, -12)
                lock.Size = UDim2.new(0, 220, 0, 27)
                lock.ZIndex = 6
                lock.Text = ""
                lock.Visible = false
                
                LockICorner.Name = "LockICorner"
                LockICorner.Parent = lock
                
                lockimg.Name = "lockimg"
                lockimg.Parent = lock
                lockimg.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                lockimg.BackgroundTransparency = 1.000
                lockimg.Position = UDim2.new(0.411167532, 0, 0, 0)
                lockimg.Size = UDim2.new(0, 25, 0, 25)
                lockimg.ZIndex = 7
                lockimg.Image = "rbxassetid://7795617792"
                
                function locktoogle:SetState(state)
                    if state then
                        ...
                        TweenService:Create(TickCover, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {Size = UDim2.new(0, 0, 0, 0)}):Play()
                    ...
                    elseif not state then
                        ...
                        TweenService:Create(TickCover, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {Size = UDim2.new(0, 14, 0, 14)}):Play()
                ...
                function locktoogle:lock()
                    lock.Visible = true
                end
                function locktoogle:unlock()
                    lock.Visible = false
                end
                return locktoogle
            end
            ...
            function SectionElements:Slider(name, minimumvalue, maximumvalue, presetvalue, precisevalue, callback)
                ...
                SliderBackground.Size = UDim2.new(0, 220, 0, 4)
                ...
                SliderValue.Position = UDim2.new(0.99, -12, 0.400000006, -12)
                SliderValue.Size = UDim2.new(0, 42, 0, 19)
                SliderValue.ZIndex = 5
                SliderValue.Image = "rbxassetid://3570695787"
                SliderValue.ImageColor3 = Color3.fromRGB(55,55,55)
            ...
            function SectionElements:ColorPicker(name, presetcolor, callback)
                ...
                NameColorPicker.Size = UDim2.new(0, 249, 0, 32)
                ...
                ColorPickerToggle.Position = UDim2.new(0, 199, 0, 5)
                ...
                ColorPicker.Position = UDim2.new(0.15, 0, 0, 30)
                ...
                Toggle.Size = UDim2.new(0, 161, 0, 20)
                Toggle.ZIndex = 10
                Toggle.AutoButtonColor = false
                Toggle.Font = Library.Theme.TextFont
                Toggle.Text = ""
                ...
                Toggle.MouseButton1Down:Connect(function()
                    ...
                    if RainbowColorPicker then              
                        ...
                        TweenService:Create(TickCover, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {Position = UDim2.new(0.9, -7,0.5, -7), Size = UDim2.new(0, 0, 0, 0)}):Play()
                        TweenService:Create(CheckboxOutline, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {ImageColor3 = Library.Theme.MainColor}):Play()
                        TweenService:Create(CheckboxTicked, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {ImageColor3 = Library.Theme.MainColor}):Play()
                    ...
                    elseif not RainbowColorPicker then
                        ...
                        TweenService:Create(TickCover, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {Position = UDim2.new(0.9, -7,0.5, -7), Size = UDim2.new(0, 14, 0, 14)}):Play()
                        TweenService:Create(CheckboxOutline, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {ImageColor3 = Color3.fromRGB(65, 65, 65)}):Play()
                        TweenService:Create(CheckboxTicked, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {ImageColor3 = Color3.fromRGB(65, 65, 65)}):Play()
                    end
                end)
                ...
                ColorPickerToggle.MouseButton1Down:Connect(function()
                    ...
                    if ColorPickerToggled then
                        TweenService:Create(NameColorPicker, TweenInfo.new(0.5, Library.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 249, 0, 210)}):Play()
                    ...
                    elseif not ColorPickerToggled then
                        TweenService:Create(NameColorPicker, TweenInfo.new(0.5, Library.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 249, 0, 32)}):Play()
            ...
            function SectionElements:Dropdown(name, options, presetoption, callback)
                ...
                TitleToggle.Size = UDim2.new(0, 228, 0, 30)
                ...
                Dropdown.Size = UDim2.new(0, 226, 0, 0)
                Dropdown.ZIndex = 15
                ...
                local function ClearAllDropdownItems()
                    ...
                    TweenService:Create(Dropdown, TweenInfo.new(0.5, Library.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 226, 0, 0)}):Play()
                end
                ...
                for i, v in pairs(options) do
                    ...
                    NameButton.Size = UDim2.new(0, 226, 0, 25)
                ...
                TitleToggle.MouseButton1Down:Connect(function()
                    ...
                    if DropdownToggled then
                        TweenService:Create(TitleToggle, TweenInfo.new(0.5, Library.Theme.EasingStyle, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
                        TweenService:Create(NameDropdown, TweenInfo.new(0.5, Library.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 226, 0, 35)}):Play()
                        TweenService:Create(Dropdown, TweenInfo.new(0.5, Library.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 226, 0, 0)}):Play()
                    elseif not DropdownToggled then
                        ...
                        TweenService:Create(NameDropdown, TweenInfo.new(0.5, Library.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 226, 0, 35 + DropdownContentLayout.AbsoluteContentSize.Y)}):Play()
                        TweenService:Create(Dropdown, TweenInfo.new(0.5, Library.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 226, 0, DropdownContentLayout.AbsoluteContentSize.Y)}):Play()
                    end
                end)
                ...
                local function Refresh(newoptions, newpresetoption, newcallback)
                    ...
                    local SelectedOption;
                    if type(newpresetoption) == "number" then
                        SelectedOption = newoptions[newpresetoption]
                    elseif type(newpresetoption) == "string" then
                        SelectedOption = newpresetoption
                    else
                        SelectedOption = "N/A"
                    end
                    TitleToggle.Text = (name .. " | " .. tostring(SelectedOption))
            ...
            function SectionElements:MultiDropdown(name, options, presetoption, showcurrent, callback)
                local presetoption = type(presetoption) == "table" and presetoption or {}
                local SelectedOption = presetoption
                local NameDropdown = Instance.new("Frame")
                local TitleToggle = Instance.new("TextButton")
                local Dropdown = Instance.new("ImageLabel")
                local DropdownContentLayout = Instance.new("UIListLayout")
                ...
                TitleToggle.ZIndex = 7
                TitleToggle.Font = Library.Theme.TextFont
                TitleToggle.Text = (showcurrent and name .. " | " ..table.concat(SelectedOption, ", ") or name)
                TitleToggle.TextColor3 = Color3.fromRGB(255, 255, 255)
                TitleToggle.TextSize = 15.000
                TitleToggle.TextXAlignment = Enum.TextXAlignment.Left
                ...
                for i, v in pairs(options) do
                    ...
                    if table.find(SelectedOption, v) then
                        NameButton.TextColor3 = Color3.fromRGB(255, 255, 255)
                    ...
                    NameButton.MouseButton1Down:Connect(function()
                        if table.find(SelectedOption, v) then
                            table.remove(SelectedOption, table.find(SelectedOption, v))
                            TitleToggle.Text = (showcurrent and name .. " | " ..table.concat(SelectedOption, ", ") or name)
                            TweenService:Create(NameButton, TweenInfo.new(0.35, Library.Theme.EasingStyle, Enum.EasingDirection.Out), {TextColor3 = Library.Theme.MainColor}):Play()
                        else
                            table.insert(SelectedOption, v)
                            TitleToggle.Text = (showcurrent and name .. " | " ..table.concat(SelectedOption, ", ") or name)
                            NameButton.TextColor3 = Color3.fromRGB(255, 255, 255)
                        end
                        callback(SelectedOption)
                ...
                local function Refresh(newoptions, newpresetoption, newshowcurrent, newcallback)
                    ClearAllDropdownItems()
                    
                    local newpresetoption = type(newpresetoption) == "table" and newpresetoption or {}
                    local SelectedOption = newpresetoption

                    TitleToggle.Text = (newshowcurrent and name .. " | " ..table.concat(SelectedOption, ", ") or name)
                    for i, v in pairs(newoptions) do
                        local NameButton = Instance.new("TextButton")
            ...
            function SectionElements:Keybind(name, presetbind, keyboardonly, holdmode, callback)
                ...
                KeybindButtonBorder.ImageTransparency = 1
                ...
                KeybindButton.Position = UDim2.new(1.429, 0,0, 0)
